            ...
            <div class= "card-body">
                ...
                <form action="/admin/transaksi/detail/create" method="POST">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-md-8">
                            <input type="text"
                                value= "{{ isset($p_detail) ? $p_detail->name : '' }}"class="form-control" disabled
                                name="nama_produk">
                        </div>
                    </div>
                    <div class="row mt-1">
                        ...
                        <div class="col-md-8">
                            <input type="number" value= "{{ isset($p_detail) ? $p_detail->harga : '' }}"
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-md-8">
                            <h5> Subtotal : {{ format_rupiah($subtotal) }}</h5>
                        </div>
                    </div>
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-md-8">
                            <a href= "/admin/transaksi" class= "btn btn-info"><i class ="fas fa-arrow-left"></i> Kembali
                            </a>
                ...
                <table class="table">
                    ...
                    @foreach ($transaksi_detail as $item)
                        <tr>
                            ...
                            <td>
                                <a href="/admin/transaksi/detail/delete?id={{ $item->id }}"><i
    ...
    <div class="col-md-6">
        <div class= "card">
            ...
            <div class="card-footer">
                <a href="/transaksi/detail/nota"><input class="btn btn-success" type=button
                        value='Cetak Nota'></a>
            </div>
        </div>
    </div>
